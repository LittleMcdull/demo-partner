...
public class RabbitConfiguration {
    ...
    private static final String PAY_CONNECTION_FACTORY_NAME = "payConnectionFactory";

    private static final String PAY_AMQP_ADMIN = "payAmqpAdmin";
    ...
    @Bean(name=PAY_CONNECTION_FACTORY_NAME)
    @Primary
    ...
    @Bean(name=PAY_AMQP_ADMIN)
    public RabbitAdmin payAmqpAdmin(@Qualifier(PAY_CONNECTION_FACTORY_NAME) ConnectionFactory connectionFactory) {
    ...
    @Bean
    public SimpleMessageConsumer<String> fanoutUserConsumer(@Qualifier("userConsumerService") UserConsumerService userConsumerService,
                                                            @Qualifier(PAY_CONNECTION_FACTORY_NAME)ConnectionFactory connectionFactory, @Qualifier(PAY_AMQP_ADMIN) RabbitAdmin rabbitAdmin  ) {
        return config(DestinationEnum.DEMO_FANOUT_USER,new UserHandler(userConsumerService),connectionFactory,rabbitAdmin);
    }
